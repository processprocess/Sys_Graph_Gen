...
In it's current form, the animations are tested by manipulating a FireBase database.

In it's current iteration it's a platform of experimentation to explore the manipulation of strings and numbers into visualizations. 
